...
\begin{tikzpicture}[scale=.9,every node/.style={minimum size=1cm},on grid]
        ...
        \end{scope}
        % Text
        \node[left=3.5cm of A, yshift=1mm, anchor=east] {\huge{Theme}};
        \node[left=3.5cm of B, yshift=1mm,anchor=east] {\huge{Coordinates}};
        \node[left=3.5cm of C, yshift=1mm,anchor=east] {\huge{Statistics}};
        \node[left=3.5cm of D, yshift=1mm,anchor=east] {\huge{Facets}};
        \node[left=3.5cm of E, yshift=1mm,anchor=east] {\huge{Geometries}};
        \node[left=3.5cm of F, yshift=1mm,anchor=east] {\huge{Aesthetics}};
        \node[left=3.5cm of G, yshift=1mm,anchor=east] {\huge{Data}};
