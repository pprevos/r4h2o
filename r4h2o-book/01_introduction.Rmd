...
This book shows how to write code to solve data problems and provides a framework to create sound, useful ad aesthetic data products. The next chapter discusses the principles of data science within the context of managing a water utility. These principles are implemented with R code in the rest of the book.

Chapter three introduces the basics of the R language and concludes with a mini-case study to practice the basics.
...
Reading a book will not make you proficient in the R language, or any other practical skill for that matter. Your [journey to mastery of data science with R has seven steps](https://www.javaassignmenthelp.com/blog/how-to-learn-r-programming/):
...
This book will help you understand the basics and guides the reader through the case studies. The best way to learn from the text is to code all the example by hand. You can copy and paste them, but that is not the best way to learn, because R will interact and provide guidance as you type. Typing will also install muscle memory and help you remember to syntax.

The book contains several Mini Hackathons based on the case studies, which are coding challenges to help you practice writing simple programs. 
