...
For the involvement data, we include all columns, except the `survey_id`. The names column will be called `Item`, which contains the name of the ten items `p01` to `p10`. The values column is `Response`, which contains the results.
