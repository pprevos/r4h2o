...
R has extensive capability for visualising data and the results of analysis. The last section shows some examples of simple graphs (figure \@ref(fig:basic-plot1) and \@ref(fig:basic-plot2)).
